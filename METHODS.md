...
structures that are regions), as <!-- n:region_extents.summary.polygons -->5,951<!-- /n --> polygons over <!-- n:region_extents.summary.points -->155,933<!-- /n --> points.
...
4. **Cut the empty space into faces.** A face sealed by traced ink and holding exactly one
   abbreviation is that structure's area *as drawn*: <!-- n:region_extents.summary.faces_named_by_one_abbreviation -->3,537<!-- /n --> faces. A label the atlas set
   outside its region is seeded at the end of the line it draws rather than on the word
   (<!-- n:region_extents.summary.labels_on_a_leader -->205<!-- /n --> labels; see [Where the name is not the place](#where-the-name-is-not-the-place)).
...
| Printed labels inside the region they name | **<!-- n:region_extents.summary.label_inside_its_own_region -->0.9782<!-- /n -->**, read at the end of the label's line where the atlas draws one |
...
240 of the printed labels carry a line the leader pass read, and <!-- n:region_extents.summary.labels_on_a_leader -->205<!-- /n --> are seeded at
...
| Printed labels inside the region they name | <!-- n:region_extents.summary.label_inside_its_own_region -->0.9782<!-- /n --> | **<!-- n:vol:checks.labels_in_their_own_region -->0.9595<!-- /n -->**: the 2-D figure is after labels were pulled to the nearest face; this one is not |
