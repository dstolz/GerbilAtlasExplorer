...
regions — as <!-- n:region_extents.summary.polygons -->6,015<!-- /n --> polygons over <!-- n:region_extents.summary.points -->168,790<!-- /n --> points. Where
...
times the points. At 0.5 it does not — <!-- n:region_extents.summary.points -->168,790<!-- /n --> points against the 77,453 the 2 px pass
