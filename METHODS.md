...
structures that are regions), as <!-- n:region_extents.summary.polygons -->5,829<!-- /n --> polygons over <!-- n:region_extents.summary.points -->155,085<!-- /n --> points.
...
4. **Cut the empty space into faces.** A face sealed by traced ink and holding exactly one
   abbreviation is that structure's area *as drawn*: <!-- n:region_extents.summary.faces_named_by_one_abbreviation -->3,450<!-- /n --> faces. A label the atlas set
