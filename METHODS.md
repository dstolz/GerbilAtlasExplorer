...
structures that are regions), as <!-- n:region_extents.summary.polygons -->5,951<!-- /n --> polygons over <!-- n:region_extents.summary.points -->156,013<!-- /n --> points.
...
4. **Cut the empty space into faces.** A face sealed by traced ink and holding exactly one
   abbreviation is that structure's area *as drawn*: <!-- n:region_extents.summary.faces_named_by_one_abbreviation -->3,543<!-- /n --> faces. A label the atlas set
   outside its region is seeded at the end of the line it draws rather than on the word
   (<!-- n:region_extents.summary.labels_on_a_leader -->202<!-- /n --> labels; see [Where the name is not the place](#where-the-name-is-not-the-place)).
...
| Printed labels inside the region they name | **<!-- n:region_extents.summary.label_inside_its_own_region -->0.9774<!-- /n -->**, read at the end of the label's line where the atlas draws one |
...
240 of the printed labels carry a line the leader pass read, and <!-- n:region_extents.summary.labels_on_a_leader -->202<!-- /n --> are seeded at
...
| Regions partition the volume | a point is inside one region or none | **holds**: every voxel inside the surface carries exactly one label or is an unnamed sealed face, <!-- n:vol:checks.unnamed_fraction -->0.0196<!-- /n --> of the brain |
...
| Printed labels inside the region they name | <!-- n:region_extents.summary.label_inside_its_own_region -->0.9774<!-- /n --> | **<!-- n:vol:checks.labels_in_their_own_region -->0.959<!-- /n -->**: the 2-D figure is after labels were pulled to the nearest face; this one is not |
