...
structures that are regions), as <!-- n:region_extents.summary.polygons -->5,835<!-- /n --> polygons over <!-- n:region_extents.summary.points -->155,109<!-- /n --> points.
...
4. **Cut the empty space into faces.** A face sealed by traced ink and holding exactly one
   ...
   (<!-- n:region_extents.summary.labels_on_a_leader -->210<!-- /n --> labels; see [Where the name is not the place](#where-the-name-is-not-the-place)).
...
| Printed labels inside the region they name | **<!-- n:region_extents.summary.label_inside_its_own_region -->0.9721<!-- /n -->**, read at the end of the label's line where the atlas draws one |
...
240 of the printed labels carry a line the leader pass read, and <!-- n:region_extents.summary.labels_on_a_leader -->210<!-- /n --> are seeded at
...
| Regions partition the volume | a point is inside one region or none | **holds**: every voxel inside the surface carries exactly one label or is an unnamed sealed face, <!-- n:vol:checks.unnamed_fraction -->0.018<!-- /n --> of the brain |
...
| Printed labels inside the region they name | <!-- n:region_extents.summary.label_inside_its_own_region -->0.9721<!-- /n --> | **<!-- n:vol:checks.labels_in_their_own_region -->0.9468<!-- /n -->**: the 2-D figure is after labels were pulled to the nearest face; this one is not |
