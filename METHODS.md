...
| Printed labels inside the region they name | **<!-- n:region_extents.summary.label_inside_its_own_region -->0.9724<!-- /n -->**, read at the end of the label's line where the atlas draws one |
...
| Printed labels inside the region they name | <!-- n:region_extents.summary.label_inside_its_own_region -->0.9724<!-- /n --> | **<!-- n:vol:checks.labels_in_their_own_region -->0.9471<!-- /n -->**: the 2-D figure is after labels were pulled to the nearest face; this one is not |
...
slits, `DCl`) a median <!-- n:vol:checks.fragment_share_when_more_median -->0.1361<!-- /n --> of it sits outside the largest two. This is reported
